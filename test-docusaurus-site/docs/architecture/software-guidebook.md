<!-- markdownlint-disable MD003 MD013 MD022 MD032 MD033 MD040 MD041 MD060 -->
---
...
| `a11yDescriptionOverride` | Per-diagram natural language description override | - |
...
For the complete ADR catalog, see the source ADR index at [source ADR index on GitHub](https://github.com/bartvanderwal/remark-kroki-a11y/blob/main/docs/adr/README.md) and the published [ADR index](/adr/).
